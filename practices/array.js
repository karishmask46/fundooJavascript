...
const originalIcon = document.querySelector('.original-icon1');
const newIcon = document.querySelector('.new-icon1');
const editableInput = document.querySelector('.postedlabel');
